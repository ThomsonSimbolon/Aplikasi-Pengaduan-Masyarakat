...
{
    protected $usersModel, $keluhanModel, $masyarakatModel;
    ...
    public function index()
    {
        ...
        return view('masyarakat/v_keluhan', $data);
    }
    ...
    public function dataPribadi()
    {
        ...
        return view('masyarakat/pribadi/v_keluhan', $data);
    }
    ...
    public function add()
    {
        ...
        return view('masyarakat/v_tambah_keluhan', $data);
    }
    ...
    public function create()
    {
        ...
        if ($file_path->isValid() && !$file_path->hasMoved()) {
            ...
            $data = [
                ...
                'alamat_pengadu' => $this->request->getVar('alamat_pengadu'),
            ...
            if ($this->keluhanModel->insert($data)) {
                ...
                return redirect()->to(base_url('masyarakat/keluhan'))->with('success', 'Data berhasil ditambah');
            } else {
                // Jika gagal maka akan diredirect dan menampilkan notifikasi gagal di halaman keluhan
                session()->setFlashdata('gagal', 'Data gagal ditambahkan');
                return redirect()->to(base_url('masyarakat/keluhan'))->with('error', 'Data gagal ditambah');
            }
        }
    }
    ...
    public function edit($id)
    {
        ...
        return view('masyarakat/v_edit_keluhan', $data);
    }
    ...
    public function update($id)
    {
        ...
        if ($this->keluhanModel->update($id, $data)) {
            ...
            return redirect()->to(base_url('masyarakat/keluhan'));
        } else {
            session()->setFlashdata('gagal', 'Data gagal diubah');
            return redirect()->to(base_url('masyarakat/keluhan/edit/' . $id));
        }
    }
    ...
    public function detail($id)
    {
        ...
        return view('masyarakat/v_detail_keluhan', $data);
    }
}
