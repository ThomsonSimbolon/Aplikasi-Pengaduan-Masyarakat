...
{
    protected $usersModel, $laporanModel, $masyarakatModel;
    ...
    public function index()
    {
        ...
        return view('masyarakat/v_laporan', $data);
    }
    ...
    public function dataPribadi()
    {
        ...
        return view('masyarakat/pribadi/v_laporan', $data);
    }
    ...
    public function add()
    {
        ...
        return view('masyarakat/v_tambah_laporan', $data);
    }
    ...
    public function create()
    {
        ...
        if ($lampiran->isValid() && !$lampiran->hasMoved()) {
            ...
            if ($this->laporanModel->insert($data)) {
                ...
                return redirect()->to(base_url('masyarakat/laporan'))->with('success', 'Data berhasil ditambah');
            } else {
                // Jika gagal maka akan diredirect dan menampilkan notifikasi gagal di halaman laporan
                session()->setFlashdata('gagal', 'Data gagal ditambahkan');
                return redirect()->to(base_url('masyarakat/laporan'))->with('error', 'Data gagal ditambah');
            }
        }
    }
    ...
    public function edit($id)
    {
        ...
        return view('masyarakat/v_edit_laporan', $data);
    }
    ...
    public function update($id)
    {
        ...
        if ($this->laporanModel->update($id, $data)) {
            ...
            return redirect()->to(base_url('masyarakat/laporan'));
        } else {
            // Jika gagal maka akan diredirect dan menampilkan notifikasi gagal di halaman laporan
            session()->setFlashdata('gagal', 'Data gagal diubah');
            return redirect()->to(base_url('masyarakat/laporan/edit/' . $id));
        }
    }
    ...
    public function detail($id)
    {
        ...
        return view('masyarakat/v_detail_laporan', $data);
    }
}
