...
{
    protected $usersModel, $pertanyaanModel, $lurahModel, $jawabanModel;
    ...
    public function index()
    {
        ...
        return view('lurah/v_pertanyaan', $data);
    }
    ...
    public function dataPribadi()
    {
        ...
        return view('lurah/pribadi/v_pertanyaan', $data);
    }
    ...
    public function add()
    {
        ...
        return view('lurah/v_tambah_pertanyaan', $data);
    }
    ...
    public function create()
    {
        ...
        if ($this->pertanyaanModel->insert($data)) {
            ...
            return redirect()->to(base_url('lurah/pertanyaan'))->with('success', 'Data berhasil ditambah');
        } else {
            // Jika gagal maka akan diredirect dan menampilkan notifikasi gagal di halaman pertanyaan
            session()->setFlashdata('gagal', 'Data gagal ditambahkan');
            return redirect()->to(base_url('lurah/pertanyaan'))->with('error', 'Data gagal ditambahkan');
        }
    }
    ...
    public function edit($id)
    {
        ...
        return view('lurah/v_edit_pertanyaan', $data);
    }
    ...
    public function update($id)
    {
        ...
        if ($this->pertanyaanModel->update($id, $data)) {
            ...
            return redirect()->to(base_url('lurah/pertanyaan'));
        } else {
            session()->setFlashdata('gagal', 'Data gagal diubah');
            return redirect()->to(base_url('lurah/pertanyaan/edit/' . $id));
        }
    }
    ...
    public function detail($id)
    {
        ...
        return view('lurah/v_detail_pertanyaan', $data);
    }
    ...
    public function tambahJawaban()
    {
        ...
        return redirect()->to('/lurah/pertanyaan/detail/' . $this->request->getPost('id_pertanyaan'))->with('success', 'Data jawaban berhasil ditambahkan.');
