...
{
    protected $usersModel, $aspirasiModel, $lurahModel;
    ...
    public function index()
    {
        ...
        return view('lurah/v_aspirasi', $data);
    }
    ...
    public function dataPribadi()
    {
        ...
        return view('lurah/pribadi/v_aspirasi', $data);
    }
    ...
    public function add()
    {
        ...
        return view('lurah/v_tambah_aspirasi', $data);
    }
    ...
    public function create()
    {
        ...
        if ($lampiran->isValid() && !$lampiran->hasMoved()) {
            ...
            if ($this->aspirasiModel->insert($data)) {
                ...
                return redirect()->to(base_url('lurah/aspirasi'))->with('success', 'Data berhasil ditambah.');
            } else {
                // Jika gagal maka akan diredirect dan menampilkan notifikasi gagal di halaman aspirasi
                session()->setFlashdata('gagal', 'Data gagal ditambahkan');
                return redirect()->to(base_url('lurah/aspirasi/add'))->with('error', 'Data gagal ditambah');;
            }
        }
    }
    ...
    public function edit($id)
    {
        ...
        return view('lurah/v_edit_aspirasi', $data);
    }
    ...
    public function update($id)
    {
        ...
        if ($this->aspirasiModel->update($id, $data)) {
            ...
            return redirect()->to(base_url('lurah/aspirasi'));
        } else {
            // Jika gagal maka akan diredirect dan menampilkan notifikasi gagal di halaman aspirasi
            session()->setFlashdata('gagal', 'Data gagal diubah');
            return redirect()->to(base_url('lurah/aspirasi/edit/' . $id));
        }
    }
    ...
    public function detail($id)
    {
        ...
        return view('lurah/v_detail_aspirasi', $data);
    }
}
