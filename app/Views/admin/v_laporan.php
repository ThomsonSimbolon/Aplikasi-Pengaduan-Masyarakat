...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <a href="<?= base_url('admin/laporan/konfirmasi'); ?>" class="btn btn-success btn-sm shadow m-0"><i class="fas fa-circle-check"></i> Konfirmasi</a>
            </div><!-- /.col -->
            <div class="col-sm-6">
                ...
                <div class="card shadow card-primary card-outline">
                    ...
                    <div class="card-body table-responsive">
                        <div class="mb-3 mt-0 d-flex justify-content-between">
                            <a href="<?= base_url('admin/laporan/add'); ?>" class="btn btn-primary btn-sm shadow">Tambah</a>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($laporan as $lap) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url('admin/laporan/detail/' . $lap->id_laporan) ?>" class="btn btn-info btn-sm btn-laporan"><i class="fas fa-eye"></i></a>
                                                <!-- <a href=""
                                                class="btn btn-warning btn-sm btn-laporan"><i
                                                    class="fas fa-edit"></i></a> -->
                                                <a href="<?= base_url('admin/laporan/delete/' . $lap->id_laporan) ?>" class="btn btn-danger btn-sm btn-laporan"><i class="fas fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
