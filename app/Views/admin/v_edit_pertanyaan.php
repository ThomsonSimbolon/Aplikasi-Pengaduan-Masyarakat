                ...
                <div class="card shadow card-primary card-outline">
                    <div class="card-body">
                        <div class="card">
                            ...
                            <?php endif; ?>
                            <div class="card-body">
                                <form action="<?= site_url('admin/pertanyaan/update/' . $pertanyaan->id_pertanyaan); ?>" method="post" enctype="multipart/form-data">
                                    <?php csrf_field() ?>
                                    <div class="form-group">
                                        <label for="nik">NIK</label>
                                        <input type="text" class="form-control" id="nik" name="nik" value="<?= old('nik', $pertanyaan->nik); ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="kategori_pertanyaan">Kategori Pertanyaan</label>
                                        <input type="text" class="form-control" id="kategori_pertanyaan" name="kategori_pertanyaan" value="<?= old('kategori_pertanyaan', $pertanyaan->kategori_pertanyaan); ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="deskripsi">Deskripsi</label>
                                        <textarea type="text" class="form-control" id="deskripsi" name="deskripsi" rows="5"><?= old('deskripsi', $pertanyaan->deskripsi); ?></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="file_path">File</label>
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" id="file_path" name="file_path">
                                            <label class="custom-file-label" for="file_path"><?= $pertanyaan->file_path ?: 'Choose file'; ?></label>
