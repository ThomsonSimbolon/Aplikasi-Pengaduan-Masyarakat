                ...
                <div class="card shadow card-primary card-outline">
                    <div class="card-body">
                        <div class="card">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form action="<?= site_url('admin/aspirasi/create'); ?>" method="post"
                                    enctype="multipart/form-data">
                                    <?php csrf_field() ?>
                                    <div class="form-group">
                                        <label for="kategori_aspirasi">Judul aspirasi</label>
                                        <input type="text"
                                            class="form-control <?= session('errors.kategori_aspirasi') ? 'is-invalid' : null ?>"
                                            id="kategori_aspirasi" name="kategori_aspirasi"
                                            value="<?= old('kategori_aspirasi'); ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="text"
                                            class="form-control <?= session('errors.deskripsi') ? 'is-invalid' : null ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="custom-file">
                                            <input type="file"
                                                class="custom-file-input <?= session('errors.lampiran') ? 'is-invalid' : null ?>"
