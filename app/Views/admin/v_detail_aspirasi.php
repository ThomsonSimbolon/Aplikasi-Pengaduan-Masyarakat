                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="rt_rw" name="rt_rw" value="<?= old('rt_rw', $aspirasi->rt_rw); ?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="kelurahan">Kelurahan</label>
                                    <input type="text" class="form-control" id="kelurahan" name="kelurahan" value="<?= old('kelurahan', $aspirasi->kelurahan); ?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="kecamatan">Kecamatan</label>
                                    <input type="text" class="form-control" id="kecamatan" name="kecamatan" value="<?= old('kecamatan', $aspirasi->kecamatan); ?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="kabupaten">Kabupaten</label>
                                    <input type="text" class="form-control" id="kabupaten" name="kabupaten" value="<?= old('kabupaten', $aspirasi->kabupaten); ?>" readonly>
                                </div>
                                <div class="form-group">
                                    ...
                                    <?php if ($aspirasi->lampiran) : ?>
                                        <div class="container-fluid mt-4 d-flex align-items-center justify-content-center">
                                            ...
                                            if (in_array($fileExtension, ['jpg', 'jpeg', 'png', 'gif'])) : ?>
                                                <img src="<?= base_url('/assets/uploads/' . $aspirasi->lampiran); ?>" class="img-fluid" alt="Lampiran">
                                            <?php elseif (in_array($fileExtension, ['mp4', 'webm', 'ogg'])) : ?>
                                                <video controls class="img-fluid">
                                                    <source src="<?= base_url('/assets/uploads/' . $aspirasi->lampiran); ?>" type="video/<?= $fileExtension; ?>">
                                                    Browser kamu tidak support untuk memutar vidio.
                                                </video>
                                            <?php elseif ($fileExtension === 'pdf') : ?>
                                                <embed src="<?= base_url('/assets/uploads/' . $aspirasi->lampiran); ?>" type="application/pdf" width="100%" height="600px" />
                                            <?php elseif (in_array($fileExtension, ['doc', 'docx'])) : ?>
                                                <a href="<?= base_url('/assets/uploads/' . $aspirasi->lampiran); ?>" target="_blank">Download Lampiran</a>
                                            <?php else : ?>
