...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <a href="<?= base_url('admin/aspirasi/konfirmasi'); ?>" class="btn btn-success btn-sm shadow m-0"><i class="fas fa-circle-check"></i> Konfirmasi</a>
            </div><!-- /.col -->
            <div class="col-sm-6">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card shadow card-primary card-outline">
                    ...
                    <!-- Notifikasi gagal hapus aspirasi -->
                    ...
                    <div class="card-body">
                        <div class="mb-3 mt-0 d-flex justify-content-between">
                            <a href="<?= base_url('admin/aspirasi/add'); ?>" class="btn btn-primary btn-sm shadow">Tambah</a>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($aspirasi as $key => $value) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= site_url('admin/aspirasi/detail/' . $value->id_aspirasi); ?>" class="btn btn-info btn-sm shadow"><i class="fas fa-eye"></i></a>
                                                <!-- <a href="" class="btn btn-warning btn-sm shadow"><i class="fas fa-edit"></i></a> -->
                                                <a href="<?= site_url('admin/aspirasi/delete/' . $value->id_aspirasi); ?>" class="btn btn-danger btn-sm shadow"><i class="fas fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
