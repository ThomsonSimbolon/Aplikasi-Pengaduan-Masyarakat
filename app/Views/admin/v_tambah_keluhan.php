                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex align-item-center justify-content-between">
                                    ...
                                    <a href="<?= base_url('admin/keluhan'); ?>" class="text-danger"><i class="fa-solid fa-xmark"></i></a>
                                </div>
                            </div>
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form action="<?= site_url('admin/keluhan/create'); ?>" method="post" enctype="multipart/form-data">
                                    <?php csrf_field(); ?>
                                    <div class="form-group">
                                        <label for="nama_pengadu">Nama Lengkap</label>
                                        <input type="text" class="form-control <?= session('errors.nama_pengadu') ? 'is-invalid' : null ?>" id="nama_pengadu" name="nama_pengadu" value="<?= old('nama_pengadu'); ?>" placeholder="Masukkan nama lengkap...">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control <?= session('errors.kabupaten') ? 'is-invalid' : null ?>" id="kabupaten" name="kabupaten" value="<?= old('kabupaten'); ?>" placeholder="Masukkan kabupaten...">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control <?= session('errors.no_telp') ? 'is-invalid' : null ?>" id="no_telp" name="no_telp" value="<?= old('no_telp'); ?>" placeholder="Masukkan no telp...">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control <?= session('errors.judul_keluh') ? 'is-invalid' : null ?>" id="judul_keluh" name="judul_keluh" value="<?= old('judul_keluh'); ?>" placeholder="Masukkan judul keluhan...">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" class="form-control <?= session('errors.deskripsi_keluh') ? 'is-invalid' : null ?>" id="deskripsi_keluh" name="deskripsi_keluh" rows="5" placeholder="Masukkan deskripsi..."><?= old('deskripsi_keluh'); ?></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input <?= session('errors.file_path') ? 'is-invalid' : null ?>" id="file_path" name="file_path">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control <?= session('errors.kategori_keluh') ? 'is-invalid' : null ?>" id="kategori_keluh" name="kategori_keluh" value="<?= old('kategori_keluh'); ?>" placeholder="Masukkan kategori keluhan...">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control <?= session('errors.solusi_keluh') ? 'is-invalid' : null ?>" id="solusi_keluh" name="solusi_keluh" value="<?= old('solusi_keluh'); ?>" placeholder="Masukkan solusi...">
