            ...
            <div class="col-lg">
                <div class="card shadow card-primary card-outline">
                    <div class="card-header my-0">
                        <h4 class="card-title my-1 text-primary">Data Berita</h4>
                        <a href="<?= base_url('admin/berita/add'); ?>" class="btn btn-primary btn-sm shadow float-right">Tambah</a>
                    </div>
                                ...
                                <?php foreach ($berita as $beritaItem) : ?>
                                    <div class="col-lg-6 mb-5">
                                        ...
                                        <div class="card card-berita shadow h-100">
                                            <img src="<?= base_url('/assets/uploads/' . $beritaItem->file_path); ?>" class="card-img-top rounded-top" alt="Gambar Berita" style="height: 350px; object-fit: cover;">
                                            <div class="card-body">
                                            ...
                                            <div class="card-footer d-flex align-items-center justify-content-between my-0">
                                                ...
                                                <div class="btn-group position-absolute" style="top: 10px; left: 10px;">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton-<?= $beritaItem->id_berita; ?>">
                                                        ...
                                                        <a class="dropdown-item" href="<?= site_url('admin/berita/delete/' . $beritaItem->id_berita); ?>" id="hapusBtn10"><i class="fas fa-trash-alt text-danger"></i>
                                                            Hapus</a>
                                                    </div>
                                                </div>
                                            </div>
