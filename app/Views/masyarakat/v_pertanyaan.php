...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <?php if ($p) : ?>
                <a href="<?= base_url('masyarakat/pertanyaan/data-pribadi'); ?>"
                    class="btn btn-success btn-sm shadow m-0"><i class="fas fa-person"></i> Data Pribadi</a>
                <?php endif; ?>
            </div><!-- /.col -->
            <div class="col-sm-6">
                ...
                <div class="card shadow card-primary card-outline">
                    <div class="card-header">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <a href="<?= base_url('masyarakat/home'); ?>" class="text-danger"><i
                    ...
                    <div class="card-body">
                        <div class="mb-3 mt-0 d-flex justify-content-between">
                            <a href="<?= base_url('masyarakat/pertanyaan/add'); ?>"
                            ...
                            <table id="example1"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= site_url('masyarakat/pertanyaan/detail/' . $value->id_pertanyaan); ?>"
