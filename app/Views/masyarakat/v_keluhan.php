...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <a href="<?= base_url('masyarakat/keluhan/data-pribadi'); ?>" class="btn btn-success btn-sm shadow m-0"><i class="fas fa-person"></i> Data Pribadi</a>
            </div><!-- /.col -->
            <div class="col-sm-6">
                ...
                <div class="card shadow card-primary card-outline">
                    ...
                    <div class="card-body">
                        <div class="mb-3 mt-0 d-flex justify-content-between">
                            <a href="<?= base_url('masyarakat/keluhan/add'); ?>" class="btn btn-primary btn-sm shadow">Tambah</a>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($keluhan as $key => $value) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= site_url('masyarakat/keluhan/detail/' . $value->id_keluhan); ?>" class="btn btn-primary btn-sm shadow"><i class="fas fa-eye"></i>
                                                    Lihat</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
