                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex align-item-center justify-content-between">
                                    <h4 class="card-title my-0 text-primary">Tambah Aspirasi</h4>
                                    <a href="<?= base_url('masyarakat/aspirasi'); ?>" class="text-danger"><i class="fa-solid fa-xmark"></i></a>
                                </div>
                            </div>
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form action="<?= site_url('masyarakat/aspirasi/create'); ?>" method="post" enctype="multipart/form-data">
                                    <?php csrf_field() ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control <?= session('errors.kategori_aspirasi') ? 'is-invalid' : null ?>" id="kategori_aspirasi" name="kategori_aspirasi" value="<?= old('kategori_aspirasi'); ?>" placeholder="Masukkan kategori aspirasi...">

                                        <?php if (session('errors.kategori_aspirasi')) : ?>
                                            <div class="invalid-feedback">
                                                <?= session('errors.kategori_aspirasi') ?>
                                            </div>
                                        <?php endif ?>
                                    </div>
                                    <div class="form-group">
