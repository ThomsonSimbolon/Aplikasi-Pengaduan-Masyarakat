                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex align-item-center justify-content-between">
                                    ...
                                    <a href="<?= base_url('masyarakat/pertanyaan'); ?>" class="text-danger"><i class="fa-solid fa-xmark"></i></a>
                                </div>
                            </div>
                            <!-- /.card-header -->
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="kategori_pertanyaan" name="kategori_pertanyaan" value="<?= old('kategori_pertanyaan', $pertanyaan->kategori_pertanyaan); ?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="deskripsi">Deskripsi</label>
                                    <textarea class="form-control" id="deskripsi" name="deskripsi" rows="5" readonly><?= old('deskripsi', $pertanyaan->deskripsi); ?></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="tgl_pertanyaan">Tanggal Pertanyaan</label>
                                    <input type="datetime" class="form-control" id="tgl_pertanyaan" name="tgl_pertanyaan" value="<?= old('tgl_pertanyaan', $pertanyaan->tgl_pertanyaan); ?>" readonly>
                                </div>
                                <div class="form-group">
                                    ...
                                    <?php if ($pertanyaan->file_path) : ?>
                                        <div class="container-fluid mt-4 d-flex align-items-center justify-content-center">
                                            ...
                                            if (in_array($fileExtension, ['jpg', 'jpeg', 'png', 'gif'])) : ?>
                                                <img src="<?= base_url('/assets/uploads/' . $pertanyaan->file_path); ?>" class="img-fluid" alt="Lampiran">
                                            <?php elseif (in_array($fileExtension, ['mp4', 'webm', 'ogg'])) : ?>
                                                <video controls class="img-fluid">
                                                    <source src="<?= base_url('/assets/uploads/' . $pertanyaan->file_path); ?>" type="video/<?= $fileExtension; ?>">
                                                    Browser kamu tidak support untuk memutar vidio.
                                                </video>
                                            <?php elseif ($fileExtension === 'pdf') : ?>
                                                <embed src="<?= base_url('/assets/uploads/' . $pertanyaan->file_path); ?>" type="application/pdf" width="100%" height="600px" />
                                            <?php elseif (in_array($fileExtension, ['doc', 'docx'])) : ?>
                                                <a href="<?= base_url('/assets/uploads/' . $pertanyaan->file_path); ?>" target="_blank">Download Lampiran</a>
                                            <?php else : ?>
                            ...
                            <div class="card-footer border border-1 bg-transparent">
                                ...
                                <form action="<?= base_url('masyarakat/pertanyaan/detail/jawaban') ?>" method="post">
                                    <?= csrf_field() ?>
                                    ...
                                    <button type="submit" class="btn btn-primary btn-sm shadow"><i class="fas fa-paper-plane"></i> Kirim</button>
                                </form>
                            </div>
                        </div>
                    </div>
