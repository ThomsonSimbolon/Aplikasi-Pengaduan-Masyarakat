                ...
                <div class="card shadow card-primary card-outline">
                    <div class="card-body">
                        <div class="card">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form action="<?= site_url('masyarakat/pertanyaan/create'); ?>" method="post"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            class="form-control <?= session('errors.kategori_pertanyaan') ? 'is-invalid' : null ?>"
                                            id="kategori_pertanyaan" name="kategori_pertanyaan"
                                            value="<?= old('kategori_pertanyaan'); ?>"
                                            placeholder="Masukkan kategori pertanyaan..." autofocus>
