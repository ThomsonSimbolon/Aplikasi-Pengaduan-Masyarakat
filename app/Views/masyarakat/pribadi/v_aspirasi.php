                ...
                <div class="card shadow card-primary card-outline">
                    <div class="card-header">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <a href="<?= base_url('masyarakat/aspirasi'); ?>" class="text-danger"><i
                            ...
                            <table id="example1" class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= site_url('masyarakat/aspirasi/detail/' . $value->id_aspirasi); ?>"
                                                class="btn btn-primary btn-sm shadow"><i class="fas fa-eye"></i>
                                                Detail</a>
                                            <a href="<?= site_url('masyarakat/aspirasi/edit/' . $value->id_aspirasi); ?>"
