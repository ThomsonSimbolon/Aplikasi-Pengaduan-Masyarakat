                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($l as $lap) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= site_url('masyarakat/pertanyaan/detail/' . $lap->id_pertanyaan); ?>" class="btn btn-primary btn-sm shadow"><i class="fas fa-eye"></i>
                                                    Detail</a>
                                                <a href="<?= site_url('masyarakat/pertanyaan/edit/' . $lap->id_pertanyaan); ?>" class="btn btn-warning btn-sm shadow"><i class="fas fa-edit"></i>
                                                    Edit</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
