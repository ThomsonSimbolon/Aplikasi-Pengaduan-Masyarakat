                ...
                <div class="card shadow card-primary card-outline">
                    <div class="card-body">
                        <div class="card">
                            ...
                            <?php endif; ?>
                            <div class="card-body">
                                <form action="<?= site_url('masyarakat/laporan/update/' . $laporan->id_laporan); ?>" method="post" enctype="multipart/form-data">
                                    <?php csrf_field(); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="rt_rw" name="rt_rw" value="<?= old('rt_rw', $laporan->rt_rw); ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="kelurahan">Kelurahan</label>
                                        <input type="text" class="form-control" id="kelurahan" name="kelurahan" value="<?= old('kelurahan', $laporan->kelurahan); ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="kecamatan">Kecamatan</label>
                                        <input type="text" class="form-control" id="kecamatan" name="kecamatan" value="<?= old('kecamatan', $laporan->kecamatan); ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="kabupaten">Kabupaten</label>
                                        <input type="text" class="form-control" id="kabupaten" name="kabupaten" value="<?= old('kabupaten', $laporan->kabupaten); ?>">
                                    </div>
                                    <div class="form-group">
