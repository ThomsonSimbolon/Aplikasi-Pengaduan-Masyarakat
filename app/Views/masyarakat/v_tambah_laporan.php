                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex align-item-center justify-content-between">
                                    ...
                                    <a href="<?= base_url('masyarakat/laporan'); ?>" class="text-danger"><i
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form action="<?= site_url('masyarakat/laporan/create'); ?>" method="post"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            class="form-control <?= session('errors.judul_laporan') ? 'is-invalid' : null ?>"
