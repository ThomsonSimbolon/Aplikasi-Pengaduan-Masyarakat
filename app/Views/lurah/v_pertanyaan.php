...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <?php if ($p) : ?>
                <a href="<?= base_url('lurah/pertanyaan/data-pribadi'); ?>" class="btn btn-success btn-sm shadow m-0"><i
                ...
                <div class="card shadow card-primary card-outline">
                    ...
                    <div class="card-body">
                        <div class="mb-3 mt-0 d-flex justify-content-between">
                            <a href="<?= base_url('lurah/pertanyaan/add'); ?>"
                            ...
                            <table id="example1"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= site_url('lurah/pertanyaan/detail/' . $value->id_pertanyaan); ?>"
