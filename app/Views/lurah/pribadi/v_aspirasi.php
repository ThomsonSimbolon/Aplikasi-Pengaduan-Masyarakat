                ...
                <div class="card shadow card-primary card-outline">
                    <div class="card-header">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <a href="<?= base_url('lurah/aspirasi'); ?>" class="text-danger"><i class="fa-solid fa-xmark"></i></a>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($a as $key => $value) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= site_url('lurah/aspirasi/detail/' . $value->id_aspirasi); ?>" class="btn btn-primary btn-sm shadow"><i class="fas fa-eye"></i>
                                                    Detail</a>
                                                <a href="<?= site_url('lurah/aspirasi/edit/' . $value->id_aspirasi); ?>" class="btn btn-warning btn-sm shadow"><i class="fas fa-edit"></i>
                                                    Edit</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
