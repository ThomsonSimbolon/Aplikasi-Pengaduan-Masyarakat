                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-5">
                                <div class="d-flex align-items-center">
                                    <p class="card-text mb-2"><?= esc($beritaItem->penulis); ?> <i
                                            class="fas fa fa-angle-right" style="font-size: 0.8rem;"></i>
                                        <a href="<?= esc($beritaItem->url); ?>"
                                            target="_blank"><?= esc($beritaItem->judul); ?></a>
                                    </p>
                                </div>
                                <div class="card card-berita shadow h-100">
                                    <img src="<?= base_url('/assets/uploads/' . $beritaItem->file_path); ?>"
                                        class="card-img-top rounded-top w-100" alt="Gambar Berita"
                                        style="height: 350px; object-fit: cover;">
                                    <div class="card-body">
                                        <h4 class="card-title mb-1 font-weight-bold"
                                            style="text-decoration: underline;"><?= esc($beritaItem->judul); ?>
                                        </h4>
