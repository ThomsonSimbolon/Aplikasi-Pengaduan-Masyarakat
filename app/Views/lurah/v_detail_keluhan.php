                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nik" name="nik"
                                        value="<?= old('nik', $keluhan->nik); ?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="nama_pengadu">Nama Lengkap</label>
                                    <input type="text" class="form-control" id="nama_pengadu" name="nama_pengadu"
                                        value="<?= old('nama_pengadu', $keluhan->nama_pengadu); ?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="rt_rw">RT/RW</label>
                                    <input type="text" class="form-control" id="rt_rw" name="rt_rw"
                                        value="<?= old('rt_rw', $keluhan->rt_rw); ?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="kelurahan">Kelurahan</label>
                                    <input type="text" class="form-control" id="kelurahan" name="kelurahan"
                                        value="<?= old('kelurahan', $keluhan->kelurahan); ?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="kecamatan">Kecamatan</label>
                                    <input type="text" class="form-control" id="kecamatan" name="kecamatan"
                                        value="<?= old('kecamatan', $keluhan->kecamatan); ?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="kabupaten">Kabupaten</label>
                                    <input type="text" class="form-control" id="kabupaten" name="kabupaten"
                                        value="<?= old('kabupaten', $keluhan->kabupaten); ?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="no_telp">No Telp</label>
                                    <input type="text" class="form-control" id="no_telp" name="no_telp"
                                        value="<?= old('no_telp', $keluhan->no_telp); ?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="judul_keluh">Judul Keluhan</label>
                                    <input type="text" class="form-control" id="judul_keluh" name="judul_keluh"
                                        value="<?= old('judul_keluh', $keluhan->judul_keluh); ?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="deskripsi_keluh">Deskripsi</label>
                                    <textarea class="form-control" id="deskripsi_keluh" name="deskripsi_keluh" rows="5"
                                        readonly><?= old('deskripsi_keluh', $keluhan->deskripsi_keluh); ?></textarea>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="container-fluid mt-4 d-flex align-items-center justify-content-center">
                                        ...
                                        <img src="<?= base_url('/assets/uploads/' . $keluhan->file_path); ?>"
                                            class="img-fluid" alt="Lampiran">
                                        <?php elseif (in_array($fileExtension, ['mp4', 'webm', 'ogg'])) : ?>
                                        <video controls class="img-fluid">
                                            <source src="<?= base_url('/assets/uploads/' . $keluhan->file_path); ?>"
                                                type="video/<?= $fileExtension; ?>">
                                            Browser kamu tidak support untuk memutar vidio.
                                        </video>
                                        <?php elseif ($fileExtension === 'pdf') : ?>
                                        <embed src="<?= base_url('/assets/uploads/' . $keluhan->file_path); ?>"
                                            type="application/pdf" width="100%" height="600px" />
                                        <?php elseif (in_array($fileExtension, ['doc', 'docx'])) : ?>
                                        <a href="<?= base_url('/assets/uploads/' . $keluhan->file_path); ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="kategori_keluh" name="kategori_keluh"
                                        value="<?= old('kategori_keluh', $keluhan->kategori_keluh); ?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="solusi_keluh">Solusi</label>
                                    <input type="text" class="form-control" id="solusi_keluh" name="solusi_keluh"
                                        value="<?= old('solusi_keluh', $keluhan->solusi_keluh); ?>" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
