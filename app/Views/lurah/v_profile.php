...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <!-- Card untuk halamana profile lurah -->
                        ...
                        <div class="row">
                            <?php if (!empty($profile)) : ?>
                                <div class="col-md-5 d-flex flex-column align-items-center my-auto">
                                    ...
                                    <?php endif; ?>
                                    <a href="<?= base_url('lurah/profile/edit/' . $profile['id_lurah']); ?>" class="btn btn-sm btn-primary shadow"><i class="fas fa-edit"></i> Edit
                                        Profile</a>
                                </div>
                                ...
                                <div class="col-md-7">
                                    ...
                                    <ul class="list-group list-group-unbordered mb-3">
                                        ...
                                        <li class="list-group-item">
                                            <div class="row">
                                                <div class="col-md-3"><b>Foto Profile</b></div>
                                                <div class="col-md-9"><span class="mr-2">:</span>
                                                    <?= esc($profile['foto_profile']); ?>
                                                </div>
                                            </div>
                                        </li>
                                    </ul>
