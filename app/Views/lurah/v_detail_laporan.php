                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="judul_laporan" name="judul_laporan"
                                        ...
                                        placeholder="Masukkan judul laporan..." readonly>
                                </div>
                                <div class="form-group">
                                    <label for="deskripsi">Deskripsi</label>
                                    <textarea type="text" class="form-control" id="deskripsi" name="deskripsi" rows="5"
                                        placeholder="Masukkan deskripsi..."
                                        readonly><?= old('deskripsi', $laporan->deskripsi); ?></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="rt_rw">RT/RT</label>
                                    <input type="text" class="form-control" id="rt_rw" name="rt_rw"
                                        value="<?= old('rt_rw', $laporan->rt_rw); ?>" placeholder="Masukkan alamat..."
                                        readonly>
                                </div>
                                <div class="form-group">
                                    <label for="kecamatan">Kecamatan</label>
                                    <input type="text" class="form-control" id="kecamatan" name="kecamatan"
                                        value="<?= old('kecamatan', $laporan->kecamatan); ?>"
                                        placeholder="Masukkan kecamatan..." readonly>
                                </div>
                                <div class="form-group">
                                    <label for="kelurahan">Kelurahan</label>
                                    <input type="text" class="form-control" id="kelurahan" name="kelurahan"
                                        value="<?= old('kelurahan', $laporan->kelurahan); ?>"
                                        placeholder="Masukkan kelurahan..." readonly>
                                </div>
                                <div class="form-group">
                                    <label for="kabupaten">Kabupaten</label>
                                    <input type="text" class="form-control" id="kabupaten" name="kabupaten"
                                        value="<?= old('kabupaten', $laporan->kabupaten); ?>"
                                        placeholder="Masukkan kelurahan..." readonly>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="container-fluid mt-4 d-flex align-items-center justify-content-center">
                                        ...
                                        <img src="<?= base_url('/assets/uploads/' . $laporan->lampiran); ?>"
                                            class="img-fluid" alt="Lampiran">
                                        <?php elseif (in_array($fileExtension, ['mp4', 'webm', 'ogg'])) : ?>
                                        <video controls class="img-fluid">
                                            <source src="<?= base_url('/assets/uploads/' . $laporan->lampiran); ?>"
                                                type="video/<?= $fileExtension; ?>">
                                            Browser kamu tidak support untuk memutar vidio.
                                        </video>
                                        <?php elseif ($fileExtension === 'pdf') : ?>
                                        <embed src="<?= base_url('/assets/uploads/' . $laporan->lampiran); ?>"
                                            type="application/pdf" width="100%" height="600px" />
                                        <?php elseif (in_array($fileExtension, ['doc', 'docx'])) : ?>
                                        <a href="<?= base_url('/assets/uploads/' . $laporan->lampiran); ?>"
